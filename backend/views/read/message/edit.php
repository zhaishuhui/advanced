                ...
                <div class="panel-body">
                    <form action="<?= \yii\helpers\Url::to(['/read/message/add-save'])?>" class="form-horizontal " method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="account" value="<?=$film['account']?>">
                            </div>
                        </div>
                        <div class="form-group has-success">
                            <label class="col-lg-3 control-label">photo照片:</label>
                            <div class="col-lg-6">
                                <input type="file" name="photo" value="<?=$film['photo']?>">
                            </div>
                        </div>
                        <div class="form-group has-success">
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="message" value="<?=$film['message']?>">
                            </div>
                        </div>
                        <div class="form-group has-success">
                            <label class="col-lg-3 control-label">reply回复:</label>
                            <div class="col-lg-6">
                                <input type="text" name="reply" value="<?=$film['reply']?>">
                            </div>
                        </div>
