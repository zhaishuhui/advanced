        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form role="form" class="form-horizontal " action="<?=\yii\helpers\Url::to(['/read/author/add-save'])?>" method="post" enctype="multipart/form-data">
                        <div class="form-group has-success">
                            <label class="col-lg-3 control-label">作者名字</label>
                            <div class="col-lg-6">
                                <input type="text" name="name" id="email2" class="form-control">
                            </div>
                        </div>
                        <div class="form-group has-warning">
                            <label class="col-lg-3 control-label">性别</label>
                            <div class="col-lg-6">
                                <input type="radio" name="sex" id="email2" value="男">男 <br><br>
                                <input type="radio" name="sex" id="email2" value="女">女
                            </div>
                        </div>
                        <div class="form-group has-success">
                            <label class="col-lg-3 control-label">地区</label>
                            <div class="col-lg-6">
                                <input type="text" name="region" id="email2" class="form-control">
                            </div>
                        </div>
                        <div class="form-group has-success">
                            <label class="col-lg-3 control-label">个人简介</label>
                            <div class="col-lg-6">
                                <input type="text" name="intor" id="email2" class="form-control">
                            </div>
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="account" id="email2" class="form-control">
                            </div>
                        </div>
